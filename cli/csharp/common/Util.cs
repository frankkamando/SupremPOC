...
{    
    class Util
    {
        ...
        public static byte GetInput2(byte defaultValue)
        {
            string inputStr = "0";
            if (inputStr.Length > 0)
            {
        ...
        public static bool GetTimestamp2(string formatString, UInt32 defaultValue, out UInt32 timestamp)
        {
            string inputStr = "";
        ...
        {
            DateTime eventTime = ConvertFromUnixTimestamp(eventLog.dateTime);
           // int ID= (BS2EventCodeEnum)eventLog.code;
        ...
        public static System.Drawing.Image convertbytetoimage(byte[] BA)
        {
